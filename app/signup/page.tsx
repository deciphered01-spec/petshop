...
import { Mail, Lock, ArrowLeft, Loader2, User, Zap } from "lucide-react";
...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect to storefront for new customers
            router.push("/");
            router.refresh();
        } catch (err: any) {
            ...
            <div className="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden bg-slate-900 border-r border-white/10">
                ...
                <div className="relative z-10">
                    <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                        ...
                        <span className="text-2xl font-bold text-white tracking-tight">Baycarl Petshop</span>
                    </Link>
                </div>
                ...
                <div className="relative z-10">
                    ...
                    >
                        <h1 className="text-4xl font-bold text-white mb-4 leading-tight">
                            Join Baycarl Petshop
                        </h1>
                        <p className="text-slate-400 text-lg max-w-md">
                            Create an account to track orders, save your favorite products, and get exclusive offers for your pets.
                        </p>
                    </motion.div>
                </div>

                <div className="relative z-10 text-sm text-slate-500">
                    © 2024 Baycarl Petshop. Quality pet care.
                </div>
            </div>
                    ...
                    <Card className="border-slate-200 dark:border-white/10 shadow-xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm">
                        ...
                        <CardFooter>
                            <div className="text-center text-sm w-full text-slate-600 dark:text-slate-400">
                                ...
                                <Link href="/signin" className="font-medium text-emerald-600 hover:text-emerald-500 underline underline-offset-4">
                                    Sign in
                                </Link>
                            </div>
                        </CardFooter>
